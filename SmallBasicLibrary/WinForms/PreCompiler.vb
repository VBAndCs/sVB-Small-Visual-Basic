...
Namespace WinForms
    Public NotInheritable Class PreCompiler
        ...
        Private Shared typeShortcuts() As ShortcutInfo = {
                ...
                New ShortcutInfo("Lbl", VariableType.Label),
                New ShortcutInfo("Label", VariableType.Label),
                New ShortcutInfo("Lst", VariableType.ListBox),
                New ShortcutInfo("ListBox", VariableType.ListBox),
                New ShortcutInfo("Cmb", VariableType.ComboBox),
                New ShortcutInfo("ComboBox", VariableType.ComboBox),
                New ShortcutInfo("Chk", VariableType.CheckBox),
                New ShortcutInfo("CheckBox", VariableType.CheckBox),
                New ShortcutInfo("Rdo", VariableType.RadioButton),
                New ShortcutInfo("RadioButton", VariableType.RadioButton),
                New ShortcutInfo("Tgl", VariableType.ToggleButton),
                New ShortcutInfo("ToggleButton", VariableType.ToggleButton),
                New ShortcutInfo("Btn", VariableType.Button),
        ...
        Public Shared Function FillControlDefaultProperties() As Dictionary(Of String, String)
            ...
            defaultProperties(NameOf(Form).ToLower()) = "text"
            defaultProperties(NameOf(Control).ToLower()) = "name"
            defaultProperties(NameOf(TextBox).ToLower()) = "text"
            defaultProperties(NameOf(Label).ToLower()) = "text"
            defaultProperties(NameOf(ListBox).ToLower()) = "additem"
            defaultProperties(NameOf(ComboBox).ToLower()) = "additem"
            defaultProperties(NameOf(CheckBox).ToLower()) = "checked"
            defaultProperties(NameOf(RadioButton).ToLower()) = "checked"
            defaultProperties(NameOf(ToggleButton).ToLower()) = "checked"
            defaultProperties(NameOf(Button).ToLower()) = "enabled"
            defaultProperties(NameOf(MenuItem).ToLower()) = "additem"
            defaultProperties(NameOf(MainMenu).ToLower()) = "additem"
            defaultProperties(NameOf(DatePicker).ToLower()) = "selecteddate"
            defaultProperties(NameOf(ProgressBar).ToLower()) = "maximum"
            defaultProperties(NameOf(Slider).ToLower()) = "maximum"
            defaultProperties(NameOf(ScrollBar).ToLower()) = "maximum"
            defaultProperties(NameOf(ImageBox).ToLower()) = "filename"
            defaultProperties(NameOf(WinTimer).ToLower()) = "interval"
            defaultProperties(NameOf(TextWindow).ToLower()) = "writeline"
